//= require wirispluginengine/WIRISplugins.js
...
var _wrs_baseURL = "";
var _wrs_conf_editorUrl = "http://www.wiris.net/demo/editor/editor";

// RoR static integration
var _wrs_conf_editorEnabled = true;
var _wrs_conf_CASEnabled = true;
var _wrs_conf_setSize = "100px";
...
if (typeof _wrs_isMoodle24 == 'undefined') {
	...
	_wrs_conf_path = _wrs_baseURL + '/plugins/pluginwirisengine/tinymce/'; // TODO use the same variable name always
	_wrs_int_conf_async = false; // For sure!
}

_wrs_int_conf_async = false; // Rails integration core.js ajax call fails.
...
if (!_wrs_int_conf_async) {
	...
	var configUrl = _wrs_int_conf_file;
...
/* Including core.js */
_wrs_conf_configuration_loaded = true; // RoR configuration.ini not implented yet. 
tinymce.ScriptLoader.load(_wrs_conf_path + 'core/core.js');

var _wrs_conf_pluginBasePath = _wrs_conf_path; // _wrs_baseURL + '/plugins/wirisplugin';
