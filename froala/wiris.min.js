...
(function ($) {
  ...
  $.FroalaEditor.PLUGINS.wiris = function (editor) {
        ...
        function waitForCore() {
            if (window.wrs_initParse && typeof _wrs_conf_plugin_loaded != 'undefined') {
              ...
              if (this.$iframe != null) {
                ...
                var parsedContent = wrs_initParse(editor.$box.froalaEditor('html.get'), editor.opts.language);
    ...
    */
    ...
    function wrs_int_insertElementOnSelection() {
      $('#example').froalaEditor('selection.restore');
  ...
  $.FroalaEditor.RegisterCommand('wirisEditor', {
      ...
      callback: function () {
        $('#example').froalaEditor('selection.save');
