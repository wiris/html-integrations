...
(function ($) {
    ...
    function _init () {
        function waitForCore() {
            if (window.wrs_initParse && typeof _wrs_conf_plugin_loaded != 'undefined') {
                ...
                wrs_addIframeEvents(document.getElementsByTagName('iframe')[0], function (iframe, element) {
                ...
                editor.$box.on('froalaEditor.image.inserted', function (e, editor, $img, response) {
                    console.log($img);
                });
  ...
  $.FroalaEditor.RegisterCommand('alert', {
      ...
      callback: function () {
        ...
        wrs_int_openNewFormulaEditor(this.$iframe[0], 'en', true);
      }
    });
})(jQuery);

function wrs_int_insertElementOnSelection() {
  $('#example').froalaEditor('events.focus');
}
