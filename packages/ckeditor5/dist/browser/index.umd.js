(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = factory(require("ckeditor5")))
    : typeof define === "function" && define.amd
      ? define(["ckeditor5"], factory)
      : ((global = typeof globalThis !== "undefined" ? globalThis : global || self),
        (global["@wiris/mathtype-ckeditor5"] = factory(global.ckeditor5)));
})(this, function (ckeditor5) {
  "use strict";
    ...
    (function (global, factory) {
      ...
      function createDOMPurify() {
        ...
        const {
          ...
          Element,
          NodeFilter,
          NamedNodeMap = window1.NamedNodeMap || window1.MozNamedAttrMap,
          HTMLFormElement,
          DOMParser,
          trustedTypes,
        } = window1;
        ...
        /* Ideally, do not touch anything below this line */ /* ______________________________________________ */ const formElement =
        ...
        const _parseConfig = function _parseConfig() {
          ...
          /* Set configuration parameters */ ALLOWED_TAGS = objectHasOwnProperty(cfg, "ALLOWED_TAGS")
         ...
         * correctly. */ const ALL_SVG_TAGS = addToSet({}, [...svg$1, ...svgFilters, ...svgDisallowed]);
         ...
         */ const _initDocument = function _initDocument(dirty) {
          ...
          if (FORCE_BODY) {
            ...
            /* If FORCE_BODY isn't used, leading whitespace needs to be preserved manually */ const matches =
              stringMatch(dirty, /^[\r\n\t ]+/);
         ...
         */ const _sanitizeElements = function _sanitizeElements(currentNode) {
          ...
          /* Remove any ocurrence of processing instructions */ if (
            currentNode.nodeType === NODE_TYPE.progressingInstruction
          ) {
            _forceRemove(currentNode);
            return true;
          }
          ...
          /* Sanitize element content to be template-safe */ if (
            SAFE_FOR_TEMPLATES &&
            currentNode.nodeType === NODE_TYPE.text
          ) {
  ...
  var ca = {
    ...
    browser_no_compatible:
      "El teu navegador no és compatible amb AJAX. Si us plau, usa la darrera versió de Mozilla Firefox.",
  ...
  var cs = {
    ...
    browser_no_compatible:
      "Váš prohlížeč nepodporuje technologii AJAX. Použijte nejnovější verzi prohlížeče Mozilla Firefox.",
  ...
  var da = {
    ...
    browser_no_compatible:
      "Din browser er ikke kompatibel med AJAX-teknologi. Brug den nyeste version af Mozilla Firefox.",
  ...
  var de = {
    ...
    close_modal_warning:
      "Bist du sicher, dass du das Programm verlassen willst? Alle vorgenommenen Änderungen gehen damit verloren.",
    latex_name_label: "Latex-Formel",
    browser_no_compatible:
      "Dein Browser ist nicht mit der AJAX-Technologie kompatibel. Verwende bitte die neueste Version von Mozilla Firefox.",
  ...
  var el = {
    ...
    browser_no_compatible:
      "Το πρόγραμμα περιήγησής σας δεν είναι συμβατό με την τεχνολογία AJAX. Χρησιμοποιήστε την πιο πρόσφατη έκδοση του Mozilla Firefox.",
  ...
  var es = {
    ...
    browser_no_compatible:
      "Tu navegador no es complatible con AJAX. Por favor, usa la última version de Mozilla Firefox.",
  ...
  var et = {
    ...
    browser_no_compatible:
      "Teie brauser ei ühildu AJAXi tehnoloogiaga. Palun kasutage Mozilla Firefoxi uusimat versiooni.",
    ...
    exception_high_surrogate:
      "Funktsioonis fixedCharCodeAt() ei järgne kõrgemale asendusliikmele madalam asendusliige.",
  ...
  var eu = {
    ...
    latex_name_label: "LaTex Formula",
    browser_no_compatible:
      "Zure arakatzailea ez da bateragarria AJAX teknologiarekin. Erabili Mozilla Firefoxen azken bertsioa.",
  ...
  var fr = {
    ...
    browser_no_compatible:
      "Votre navigateur n’est pas compatible avec la technologie AJAX. Veuillez utiliser la dernière version de Mozilla Firefox.",
  ...
  var gl = {
    ...
    browser_no_compatible:
      "O seu explorador non é compatible coa tecnoloxía AJAX. Use a versión máis recente de Mozilla Firefox.",
  ...
  var hr = {
    ...
    latex_name_label: "Latex formula",
    browser_no_compatible:
      "Vaš preglednik nije kompatibilan s AJAX tehnologijom. Upotrijebite najnoviju verziju Mozilla Firefoxa.",
  ...
  var hu = {
    ...
    browser_no_compatible:
      "A böngészője nem kompatibilis az AJAX technológiával. Használja a Mozilla Firefox legújabb verzióját.",
    ...
    exception_high_surrogate:
      "A magas helyettesítő karaktert nem alacsony helyettesítő karakter követi a fixedCharCodeAt() esetében",
  ...
  var id = {
    ...
    browser_no_compatible:
      "Penjelajah Anda tidak kompatibel dengan teknologi AJAX. Harap gunakan Mozilla Firefox versi terbaru.",
  ...
  var it = {
    ...
    browser_no_compatible:
      "Il tuo browser non è compatibile con la tecnologia AJAX. Utilizza la versione più recente di Mozilla Firefox.",
  ...
  var ja = {
    ...
    browser_no_compatible:
      "お使いのブラウザは、AJAX 技術と互換性がありません。Mozilla Firefox の最新バージョンをご使用ください。",
  ...
  var ko = {
    ...
    browser_no_compatible:
      "사용자의 브라우저는 AJAX 기술과 호환되지 않습니다. Mozilla Firefox 최신 버전을 사용하십시오.",
  ...
  var nl = {
    ...
    browser_no_compatible:
      "Je browser is niet compatibel met AJAX-technologie. Gebruik de meest recente versie van Mozilla Firefox.",
  ...
  var no = {
    ...
    latex_name_label: "LaTeX-formel",
    browser_no_compatible:
      "Nettlesaren er ikkje kompatibel med AJAX-teknologien. Bruk den nyaste versjonen av Mozilla Firefox.",
  ...
  var nb = {
    ...
    latex_name_label: "LaTeX-formel",
    browser_no_compatible:
      "Nettleseren er ikke kompatibel med AJAX-teknologien. Bruk den nyeste versjonen av Mozilla Firefox.",
  ...
  var pl = {
    ...
    browser_no_compatible:
      "Twoja przeglądarka jest niezgodna z technologią AJAX Użyj najnowszej wersji Mozilla Firefox.",
  ...
  var pt = {
    ...
    latex_name_label: "Fórmula Latex",
    browser_no_compatible:
      "O seu navegador não é compatível com a tecnologia AJAX. Utilize a versão mais recente do Mozilla Firefox.",
  ...
  var pt_br = {
    ...
    latex_name_label: "Fórmula LaTeX",
    browser_no_compatible:
      "O navegador não é compatível com a tecnologia AJAX. Use a versão mais recente do Mozilla Firefox.",
    error_convert_accessibility: "Erro ao converter de MathML para texto acessível.",
  ...
  var ro = {
    ...
    browser_no_compatible:
      "Browserul dvs. nu este compatibil cu tehnologia AJAX. Utilizați cea mai recentă versiune de Mozilla Firefox.",
  ...
  var ru = {
    ...
    exception_high_surrogate:
      "Младший символ-заместитель не сопровождает старший символ-заместитель в исправленном методе CharCodeAt()",
  ...
  var sv = {
    ...
    latex_name_label: "Latex-formel",
    browser_no_compatible:
      "Din webbläsare är inte kompatibel med AJAX-teknik. Använd den senaste versionen av Mozilla Firefox.",
  ...
  var tr = {
    ...
    browser_no_compatible:
      "Tarayıcınız AJAX teknolojisiyle uyumlu değil. Lütfen en güncel Mozilla Firefox sürümünü kullanın.",
      ...
      input = new URL(
        ...
        typeof document === "undefined" && typeof location === "undefined"
          ...
          : typeof document === "undefined"
            ? location.href
            : (_documentCurrentScript && _documentCurrentScript.src) || new URL("index.umd.js", document.baseURI).href,
      );
    }
   ...
   */ class Telemeter {
     ...
     */ static init(telemeterAttributes) {
      if (!this.telemeter && !this.waitingForInit) {
        ...
        __wbg_init(telemeterAttributes.url)
          .then(() => {
            this.telemeter = new Telemeter$1(
   ...
   */ class ModalDialog {
     ...
     */ create() {
      /* Modal Window Structure
       ...
       | | |___________________________________________________________________________| | |
       | |_______________________________________________________________________________| |
       |___________________________________________________________________________________| */ this.titleBar.appendChild(
        this.closeDiv,
      );
      ...
      if (target) {
        ...
        if (selectedItem) {
          ...
          if (
            ...
            Util.containsClass(selectedItem.node, Configuration.get("imageClassName"))
          ) {
     ...
     */ _addConverters(integration) {
      ...
      editor.data.upcastDispatcher.on("element:math", (evt, data, conversionApi) => {
        ...
        /* Model node that contains what's going to actually be inserted. This can be either:
               ...
               - If the original <math> had a LaTeX annotation, then the annotation surrounded by "$$...$$" */ const modelNode =
          isLatex
            ? writer.createText(Parser.initParse(formula, integration.getLanguage()))
            : writer.createElement("mathml", {
                formula,
              });
      ...
      editor.editing.mapper.on(
        "viewToModelPosition",
        ckeditor5.viewToModelPositionOutsideModelElement(editor.model, (viewElement) =>
