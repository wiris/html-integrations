...
export class Telemeter {
    ...
    */
    identify(sender_id) {
        ...
        const ret = wasm.telemeter_identify(this.ptr, ptr0, len0);
    ...
    */
    track(event_type, event_payload) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.telemeter_track(this.ptr, ptr0, len0, addHeapObject(event_payload));
        return takeObject(ret);
    }
    /**
    * @param {any} level
    ...
    */
    log(level, message, payload) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.telemeter_log(this.ptr, addHeapObject(level), ptr0, len0, addHeapObject(payload));
        return takeObject(ret);
    }
    /**
    * @returns {Promise<any>}
    ...
    */
    debug(new_debug_status) {
        wasm.telemeter_debug(this.ptr, isLikeNone(new_debug_status) ? 0xFFFFFF : new_debug_status ? 1 : 0);
    }
}
...
function getImports() {
    ...
    imports.wbg.__wbg_platform_08177093992f63af = function() { return handleError(function (arg0, arg1) {
    ...
    imports.wbg.__wbg_hardwareConcurrency_7f791e497c5902da = function(arg0) {
    ...
    imports.wbg.__wbg_pixelDepth_a40e2ee09b3271b0 = function() { return handleError(function (arg0) {
        const ret = getObject(arg0).pixelDepth;
        return ret;
    }, arguments) };
    imports.wbg.__wbg_maxTouchPoints_b4a9ba273d1f3356 = function(arg0) {
    ...
    imports.wbg.__wbg_sort_f0dfc15a307713ed = function(arg0) {
    ...
    imports.wbg.__wbg_warn_4e56915dfd6d9a1c = function(arg0, arg1) {
    ...
    imports.wbg.__wbindgen_closure_wrapper1541 = function(arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 83, __wbg_adapter_34);
        return addHeapObject(ret);
    };
