module.exports = {
  ...
  rules: {
    ...
    'no-restricted-syntax': [ // Disable restricted syntax on forin and forof loops. TODO -> Apply the recommended behavior if possible
      'error',
      'LabeledStatement',
      'WithStatement',
    ],
    ...
    'no-mixed-operators': [ // Define the operators that can not be mixed in the same statement of comparison
      'error',
      {
        groups: [
          [
    ...
    'no-underscore-dangle': [ // Let the BROWSER_GLOBAL variable used in the jest configuration to have an underscore dangle (since it's a private var)
      'error',
      {
        allow: [
          '__BROWSER_GLOBAL__',
