...
{
    public partial class setter : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String keyValues = provider.getRequiredParameter("value");
            pb.getConfiguration().setConfigurations(variableKeys, keyValues);
