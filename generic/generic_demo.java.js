...
var _wrs_conf_editorPath ='app/editor';	// Specifies where is the editor HTML code (for popup window)
var _wrs_conf_editorAttributes = 'width=570, height=450, scroll=no, resizable=yes';							// Specifies formula editor window options.
var _wrs_conf_CASPath = 'app/cas';			// Specifies where is the WIRIS cas HTML code (for popup window)
var _wrs_conf_CASAttributes = 'width=640, height=480, scroll=no, resizable=yes';		// Specifies WIRIS cas window options

var _wrs_conf_createimagePath = 'app/createimage';			// Specifies where is createimage script
var _wrs_conf_createcasimagePath = 'app/createcasimage';	// Specifies where is createcasimage script

var _wrs_conf_getmathmlPath = 'app/getmathml';			// Specifies where is the getmathml script.
var _wrs_conf_servicePath = 'app/service';				// Specifies where is the service script.
