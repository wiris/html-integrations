...
if (isset($_GET['mode']) && $_GET['mode'] == 'applet') {
	...
	<html>
		...
		<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
			<applet id="applet" alt="WIRIS CAS" codebase="<% Response.Write(wrs_htmlentities(codebase, true)) %>" archive="<% Response.Write(wrs_htmlentities(archive, true)) %>" code="<% Response.Write(wrs_htmlentities(className, true)) %>" width="100%" height="100%">
