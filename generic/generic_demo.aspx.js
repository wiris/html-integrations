...
var _wrs_conf_editorPath = _wrs_currentPath + 'integration/editor.aspx';	// Specifies where is the editor HTML code (for popup window)
var _wrs_conf_editorAttributes = 'width=570, height=450, scroll=no, resizable=yes';							// Specifies formula editor window options.
var _wrs_conf_CASPath = _wrs_currentPath + 'integration/cas.aspx';			// Specifies where is the WIRIS cas HTML code (for popup window)
var _wrs_conf_CASAttributes = 'width=640, height=480, scroll=no, resizable=yes';		// Specifies WIRIS cas window options

var _wrs_conf_createimagePath = _wrs_currentPath + 'integration/createimage.aspx';			// Specifies where is createimage script
var _wrs_conf_createcasimagePath = _wrs_currentPath + 'integration/createcasimage.aspx';	// Specifies where is createcasimage script

var _wrs_conf_getmathmlPath = _wrs_currentPath + 'integration/getmathml.aspx';			// Specifies where is the getmathml script.
var _wrs_conf_servicePath = _wrs_currentPath + 'integration/service.aspx';				// Specifies where is the service script.
