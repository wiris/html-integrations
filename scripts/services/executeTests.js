  ...
  resolve(
    ...
    //   pathsRoutes.map(async (route) => { sequenceExecution(route); }),  // Run all the tests
      [ // Run the tests by package
        ...
        sequenceExecution(testFolders.mathFroala3),
        sequenceExecution(testFolders.mathCKEditor5),
        sequenceExecution(testFolders.mathCKEditor4),
        sequenceExecution(testFolders.mathGeneric),
        sequenceExecution(testFolders.mathFroala2),
        // sequenceExecution(testFolders.html5TinyMCE4),
        sequenceExecution(testFolders.mathTinyMCE5)
      ],
    ),
  );
});
